...
class player:
	...
	def __properties__(self):
		...
		self.symbols = {'%7c':'|', '%27':'\'', '%c2%bf':'¿', '%c2%b4':'´', 
					'%2b':'+', '%7b':'{','%7d':'}','%2c':',', '%3b':';',
					'%5b':'[', '%5d':']', '%c2%a8':'¨', '%2a':'*',
					'%c2%b0':'°','%21':'!','%22':'"','%23':'#','%24':'$',
					'%25':'%','%26':'&','%28':'(','%29':')','%3d':'=',
					'%3f':'?','%c2%a1':'¡','%3c':'<', '%3e':'>', '%c2%ac':'¬',
					'%40':'@','%c2%b7':'·', '%7e':'~', '%c2%bd':'½', 
					'%c2%ac':'¬', '%5c':'\\', '%c3%b1':'ñ', '%c3%91':'Ñ',
					'%c3%a1':'á', '%c3%a9':'é', '%c3%ad':'í', '%c3%b3':'ó', 
					'%c3%ba':'ú', '%c3%81':'Á', '%c3%89':'É', '%c3%8d':'Í', 
	...
	def __set_hotkeys__(self):
		...
		keybinder.bind(key_start, self.xmms2_start)
		key_pause = "<Ctrl><Alt>X"		
		keybinder.bind(key_pause, self.xmms2_pause)
